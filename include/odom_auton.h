...
extern void drive_to_point_reverse_with_heading (double target_x_pos, double target_y_pos, float target_heading, float max_time, float linear_kP, float linear_kI, float linear_kD, float angular_kP, float angular_kI, float angular_kD, float max_linear_speed, float min_linear_speed, float max_angular_speed, float dead_zone_distance, float max_accel);
